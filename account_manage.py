...
class EncryptedAccountManager:
    ...
    def add_account(self, name, account_info):
        self.accounts.append({"name": name, "info": account_info})
    ...
    def update_account_by_name(self, name, updated_account_info):
        for account in self.accounts:
            if account["name"] == name:
                account["info"] = updated_account_info
                break
